...
Though the majority of anti-NGO laws have targeted foreign funding, other laws seek to impose barriers to entry, such as strict and burdensome registration requirements, and barriers to advocacy that explicitly limit NGO political participation [@Chaudhry:2022]. Donor countries respond differently to these types of oppression. @ChaudhryHeiss:2024 (see also @ChaudhryHeiss:2022a) find that bilateral donors are quite responsive to barriers to advocacy—on average, total foreign aid decreases by 30–40% (or \$100 in a typical country) following the passage of an advocacy-focused NGO law. @RightSpringmanWibbels:2024 find similar and more nuanced trends in donor responses: donors committed to political advocacy   (i.e. those that fund democracy and civil society promotion activities) reduce funding for advocacy programs by more than 70% in response to new restrictions, and the reduction in aid persists for several years.

Overall bilateral aid does not decrease significantly in response to new barriers to entry, but the distribution channels of that aid shift as donor countries channel more aid through domestic rather than foreign NGOs [@ChaudhryHeiss:2024]. USAID even explicitly encourages its program managers to rely more on domestic, in-country NGOs when facing a restrictive legal environment [@USAID:2014, 6–7]. In addition to changing the amounts and recipients of foreign aid, donor agencies often adjust the focus of the programs they fund, redirecting funding away from programs related to politically sensitive issues like human rights, anti-corruption, and democratic development and towards tamer topics that are more compatible with recipient-country preferences, such as education, health, and humanitarian services [@Bush:2015; @CheesemanDesrosiers:2023].

These shifts in funding patterns in response to restrictive civil society laws have had measurable effects on NGOs in recipient countries. Samantha Power, current administrator of USAID, has pledged to send 25% of USAID funding to local NGOs over the next few years, though practical obstacles remain. New local partners take longer to vet and train compared to established INGO partners. Turning to local organizations entails greater risk, as domestic NGOs can be easily shut down based on the whims of the government. Additionally,  communities often distrust local groups that accept Western aid, especially those focused on democracy assistance. Donor preferences have also changed. Over the past two decades, bilateral donors have increasingly provided short-term grants for projects that have easily measurable, quantifiable outputs [@Bush:2015]. This model may work well for civic groups working on relatively tame causes or exclusively development-focused goals, but more contentious organizations facing government crackdown may need flexible funding that does not bring immediate results or does not have easily measurable goals.


## Private donors and foundations

- Why individual donors are important
- Donor reactions are more than just binary, but there now fancy figure 1 decision tree yet, since (1) the existing literature is much smaller, and (2) individual donors have less power in relation to states. Countries don’t counter-react to donor shifts in behavior
- Different pathways exist, though, depending on donor preferences and organization characteristics. As with diverging studies in the effect of repression on formal aid, there are different effects. Experiment paper + simulation paper + conjoint paper (getting at donor and org features)

In other cases, donors shift their aid to different programs. - both good and bad. Bush and taming + USAID

While research in public policy examines philanthropic giving to NGOs, the discipline of political science and international relations tends to see philanthropy as less relevant. However, philanthropy can help us understand changes in the dynamics of global governance. Private individuals exercise power and influence in unique ways that differ from other non-state actors. Understanding the dynamics of supporting international causes is important as philanthropy towards such causes can be harder to motivate because the number of recipients is larger and further removed from the donor.

While private sources can help raise such funds, official donor aid may not be easily replaceable by other sources. Testimony at a US Senate Committee on Foreign Relations hearing maintained that, “Neither remittances nor philanthropy can replace the expertise, scale, or agenda setting capacity of American foreign policy assistance.” Thus, despite promising new research on how to raise funds from private sources for besieged NGOs abroad, official aid donors also need to mount a coherent response to the shrinking civic space.
